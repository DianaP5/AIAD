...
public class Utilities {
	...
	public static ArrayList<String> processServiceRequest(String content) {
		return processProposal(content);
	}
	...
	public static int NUMBER_TAXIS = 3;
	public static int TAXI_CAPACITY = 4;
	public final static String CENTRAL_AID = "Central@Taxi Manager"; // central
																		// fixed
																		// AID
